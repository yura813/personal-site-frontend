...
<template>
  <div>
    ...
    <div class="bg-purple-100 min-h-screen flex flex-col gap-16 pt-40">
        ...
        <div>
          ...
          <div class="w-full flex justify-between">
            <p>
              ...
              <br />
              My interest in product design and the interaction between people
              and technology began in university through design thinking and
              UI/UX courses. Wanting to turn ideas into reality, I joined the
              Front-End Application Development Bootcamp to learn front-end
              skills, aiming to bridge design and technology.
            </p>
          </div>
        </div>
      </div>
      <div class="relative px-40 tracking-wide">
        <div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <p>
              ● Led an eight-member team project, managing feature assignments and
